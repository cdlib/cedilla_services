...
class InternetArchive < Sinatra::Application
  ...
  default = "The Internet Archive service is expecting an HTTP POST with a JSON message similar to the examples found on: " +
  ...
  post '/internet_archive' do
    ...
    begin  
      ...
      begin
        if citation.authors.size <= 0 or (citation.title.nil? and citation.book_title.nil?)
